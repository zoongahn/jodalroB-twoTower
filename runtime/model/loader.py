...
# Runtime 내부 import로 변경 (나중에 복사할 예정)
# 일단은 원본 경로를 유지하되 주석 처리
# from jodalrob_step1_runtime.preprocess.schema import TorchRecSchema, build_torchrec_schema_from_meta
# from jodalrob_step1_runtime.preprocess.feature_preprocessor import FeaturePreprocessor
# from jodalrob_step1_runtime.model.towers import NoticeTower, CompanyTower
